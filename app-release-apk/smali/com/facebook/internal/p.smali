...
# static fields
.field private static final a:Ljava/lang/String; = "com.facebook.internal.p"
...
.method static constructor <clinit>()V
    ...
    invoke-static {}, Lcom/facebook/internal/p;->d()Ljava/util/List;

    move-result-object v0

    sput-object v0, Lcom/facebook/internal/p;->c:Ljava/util/List;

    invoke-static {}, Lcom/facebook/internal/p;->c()Ljava/util/Map;
...
.method public static a(I)I
    ...
    invoke-static {v0, v1}, Lcom/facebook/internal/p;->a(Ljava/util/List;[I)Lcom/facebook/internal/p$g;

    move-result-object p0

    invoke-virtual {p0}, Lcom/facebook/internal/p$g;->a()I
...
.method public static a(Landroid/content/Context;)Landroid/content/Intent;
    ...
    invoke-virtual {v1}, Lcom/facebook/internal/p$f;->c()Ljava/lang/String;
    ...
    invoke-static {p0, v2, v1}, Lcom/facebook/internal/p;->b(Landroid/content/Context;Landroid/content/Intent;Lcom/facebook/internal/p$f;)Landroid/content/Intent;
...
.method static a(Landroid/content/Context;Landroid/content/Intent;Lcom/facebook/internal/p$f;)Landroid/content/Intent;
    .locals 2
...
.method public static a(Landroid/content/Context;Ljava/lang/String;Ljava/util/Collection;Ljava/lang/String;ZZLcom/facebook/login/a;Ljava/lang/String;Ljava/lang/String;)Landroid/content/Intent;
    ...
    new-instance v9, Lcom/facebook/internal/p$c;

    const/4 v0, 0x0

    invoke-direct {v9, v0}, Lcom/facebook/internal/p$c;-><init>(Lcom/facebook/internal/p$a;)V
    ...
    invoke-static/range {v0 .. v8}, Lcom/facebook/internal/p;->a(Lcom/facebook/internal/p$f;Ljava/lang/String;Ljava/util/Collection;Ljava/lang/String;ZZLcom/facebook/login/a;Ljava/lang/String;Ljava/lang/String;)Landroid/content/Intent;

    move-result-object v0

    move-object v1, p0

    invoke-static {p0, v0, v9}, Lcom/facebook/internal/p;->a(Landroid/content/Context;Landroid/content/Intent;Lcom/facebook/internal/p$f;)Landroid/content/Intent;
...
.method public static a(Landroid/content/Intent;Landroid/os/Bundle;Lcom/facebook/e;)Landroid/content/Intent;
    .locals 3

    invoke-static {p0}, Lcom/facebook/internal/p;->a(Landroid/content/Intent;)Ljava/util/UUID;
    ...
    invoke-static {p0}, Lcom/facebook/internal/p;->c(Landroid/content/Intent;)I
    ...
    invoke-static {p2}, Lcom/facebook/internal/p;->a(Lcom/facebook/e;)Landroid/os/Bundle;
...
.method private static a(Lcom/facebook/internal/p$f;Ljava/lang/String;Ljava/util/Collection;Ljava/lang/String;ZZLcom/facebook/login/a;Ljava/lang/String;Ljava/lang/String;)Landroid/content/Intent;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {p0}, Lcom/facebook/internal/p$f;->b()Ljava/lang/String;
    ...
    invoke-virtual {p0}, Lcom/facebook/internal/p$f;->c()Ljava/lang/String;
    ...
    :cond_1
    invoke-static {p3}, Lcom/facebook/internal/u;->c(Ljava/lang/String;)Z
...
.method public static a(Lcom/facebook/e;)Landroid/os/Bundle;
    .locals 3
...
.method public static a(Landroid/os/Bundle;)Lcom/facebook/e;
    .locals 2
...
.method private static a(Ljava/util/List;[I)Lcom/facebook/internal/p$g;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static {}, Lcom/facebook/internal/p$g;->b()Lcom/facebook/internal/p$g;
    ...
    check-cast v0, Lcom/facebook/internal/p$f;

    invoke-virtual {v0}, Lcom/facebook/internal/p$f;->a()Ljava/util/TreeSet;
    ...
    invoke-static {v1, v2, p1}, Lcom/facebook/internal/p;->a(Ljava/util/TreeSet;I[I)I
    ...
    invoke-static {v0, v1}, Lcom/facebook/internal/p$g;->a(Lcom/facebook/internal/p$f;I)Lcom/facebook/internal/p$g;
...
.method static synthetic a(Lcom/facebook/internal/p$f;)Ljava/util/TreeSet;
    .locals 0

    invoke-static {p0}, Lcom/facebook/internal/p;->c(Lcom/facebook/internal/p$f;)Ljava/util/TreeSet;
...
.method static b(Landroid/content/Context;Landroid/content/Intent;Lcom/facebook/internal/p$f;)Landroid/content/Intent;
    .locals 2
...
.method public static b(Landroid/content/Context;Ljava/lang/String;Ljava/util/Collection;Ljava/lang/String;ZZLcom/facebook/login/a;Ljava/lang/String;Ljava/lang/String;)Landroid/content/Intent;
    ...
    invoke-static/range {v2 .. v10}, Lcom/facebook/internal/p;->a(Lcom/facebook/internal/p$f;Ljava/lang/String;Ljava/util/Collection;Ljava/lang/String;ZZLcom/facebook/login/a;Ljava/lang/String;Ljava/lang/String;)Landroid/content/Intent;

    move-result-object v2

    move-object v3, p0

    invoke-static {p0, v2, v1}, Lcom/facebook/internal/p;->a(Landroid/content/Context;Landroid/content/Intent;Lcom/facebook/internal/p$f;)Landroid/content/Intent;
...
.method private static b(Lcom/facebook/internal/p$f;)Landroid/net/Uri;
    .locals 2
...
.method private static c()Ljava/util/Map;
    ...
    new-instance v2, Lcom/facebook/internal/p$e;

    const/4 v3, 0x0

    invoke-direct {v2, v3}, Lcom/facebook/internal/p$e;-><init>(Lcom/facebook/internal/p$a;)V
...
.method private static c(Lcom/facebook/internal/p$f;)Ljava/util/TreeSet;
    .locals 10
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static {p0}, Lcom/facebook/internal/p;->b(Lcom/facebook/internal/p$f;)Landroid/net/Uri;
    ...
    :catch_1
    :try_start_4
    sget-object p0, Lcom/facebook/internal/p;->a:Ljava/lang/String;
...
.method private static d()Ljava/util/List;
    ...
    new-instance v1, Lcom/facebook/internal/p$b;

    const/4 v2, 0x0

    invoke-direct {v1, v2}, Lcom/facebook/internal/p$b;-><init>(Lcom/facebook/internal/p$a;)V
...
.method private static e()Ljava/util/List;
    ...
    invoke-direct {v1, v2}, Lcom/facebook/internal/p$d;-><init>(Lcom/facebook/internal/p$a;)V

    invoke-interface {v0, v1}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    new-instance v1, Lcom/facebook/internal/p$h;

    invoke-direct {v1, v2}, Lcom/facebook/internal/p$h;-><init>(Lcom/facebook/internal/p$a;)V
...
.method public static g()V
    ...
    invoke-direct {v1}, Lcom/facebook/internal/p$a;-><init>()V
