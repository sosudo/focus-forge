...
.method private b(Lcom/facebook/login/LoginClient$Request;Landroid/content/Intent;)Lcom/facebook/login/LoginClient$Result;
    ...
    invoke-static {v4}, Lcom/facebook/internal/u;->c(Ljava/lang/String;)Z

    move-result v5

    if-nez v5, :cond_1

    invoke-virtual {p0, v4}, Lcom/facebook/login/LoginMethodHandler;->b(Ljava/lang/String;)V
    ...
    invoke-static {v0, p2, v1, v2}, Lcom/facebook/login/LoginMethodHandler;->a(Ljava/util/Collection;Landroid/os/Bundle;Lcom/facebook/c;Ljava/lang/String;)Lcom/facebook/AccessToken;
...
.method protected a(Landroid/content/Intent;I)Z
    ...
    invoke-virtual {v1}, Lcom/facebook/login/LoginClient;->e()Landroid/support/v4/app/Fragment;
